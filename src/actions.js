...
export const addReservation = reservation => dispatch => {
    fetch('https://localhost:3000/api/v1/reservation/', {
        method: 'post',
...
export const fetchReservations = () => dispatch => {
    ...
    fetch('https://localhost:3000/api/v1/reservations/', {})
        .then(response => {
...
export const setReservation = reservationId => dispatch => {
    ...
    fetch(`https://localhost:3000/api/v1/reservation/${reservationId}`, {})
        .then(response => {
            return response.json();
        })
        .then(reservation => {
